...
public class ItemCategoryController extends BaseController {
    ...
    * */
    ...
    public String update(Integer id,Model model){//Model穿参数到页面
...
* */
    ...
    public String fingBySql2(ItemCategory itemCategory,Model model){
    ...
    public String update2(Integer id,Model model){//Model穿参数到页面
        ItemCategory  obj=itemCategoryService.load(id);
        model.addAttribute("obj",obj);
